...
QT_MOC_LITERAL(1, 42, 14), // "displayMetrics"
...
void omnetpp::qtenv::AnimationControllerDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        AnimationControllerDialog *_t = static_cast<AnimationControllerDialog *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->displayMetrics(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject omnetpp::qtenv::AnimationControllerDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_omnetpp__qtenv__AnimationControllerDialog.data,
      qt_meta_data_omnetpp__qtenv__AnimationControllerDialog,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *omnetpp::qtenv::AnimationControllerDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_omnetpp__qtenv__AnimationControllerDialog.stringdata0))
        return static_cast<void*>(const_cast< AnimationControllerDialog*>(this));
